...
def compute_predict(data: np.array, feature_event_predict, event_occur):
...
def exercise_binary_classification():
    ...
    compute_predict(data, feature_event_predict, event_occur)
    # # Get features and event predict
    # features = get_feature(data)
    # event_predict = get_all_class_predict(features[feature_event_predict], data)
    # new_data = np.delete(data, 0, 0)
...
def multi_label_classification():
    ...
    feature_event_predict_traffic = "Class"
    compute_predict(data_traffic, feature_event_predict_traffic, event_occur_traffic)
